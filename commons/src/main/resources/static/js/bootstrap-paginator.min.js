!function ($) {
    ...
    BootstrapPaginator.prototype = {
        init: function (element, options) {
            ...
            return itemContainer.addClass(itemContainerClass).append(itemContent),itemContainer.addClass("page-item"),itemContainer.find("a").addClass("page-link"), itemContent.addClass(itemContentClass).html(text).on("click", null, {
                type: type,
                page: page
